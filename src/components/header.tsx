        ...
        <nav className="hidden md:flex items-center justify-between h-20 lg:h-24" role="navigation" aria-label="Main navigation">
          ...
          <div className="flex items-center space-x-4">
            ...
            {!pathname?.startsWith('/quote') && (
              <Link
                href="/quote"
                className="bg-pink-600 hover:bg-pink-700 text-white font-semibold px-5 py-2.5 rounded-md transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-pink-500 focus-visible:ring-offset-2"
              >
                Get a price
              </Link>
            )}
