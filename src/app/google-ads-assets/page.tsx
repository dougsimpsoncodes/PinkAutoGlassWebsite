...
// Accessible at: /google-ads-assets

export const metadata: Metadata = {
  title: 'Marketing Assets - Pink Auto Glass',
  description: 'Marketing assets and logos for Pink Auto Glass',
  robots: {
    index: false,
    follow: false,
  },
    ...
    <div className="min-h-screen bg-white py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">
          Pink Auto Glass - Marketing Assets
        </h1>
        <p className="text-gray-600 mb-12">
          This page hosts our brand assets for Google Ads and other marketing platforms.
        </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <Image
                ...
                className="w-full h-auto"
              />
              <p className="text-sm text-gray-600 mt-2">Horizontal Original (1024x1024)</p>
            </div>
        ...
        <section className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
          ...
          <p className="text-sm text-gray-600 mt-4">
            This page URL for Google Ads scanning: https://pinkautoglass.com/google-ads-assets
          </p>
        </section>
