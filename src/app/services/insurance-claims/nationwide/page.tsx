...
export default function StateFarmInsurancePage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Nationwide', url: 'https://pinkautoglass.com/services/insurance-claims/nationwide' }
  ]);
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-800 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <CTAButtons source="nationwide-insurance" />
            </div>
          </div>
        </section>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="bg-gradient-to-r from-red-600 to-red-800 text-white rounded-xl p-8 text-center">
                ...
                <CTAButtons source="nationwide-cta" />
              </section>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-4 space-y-6">
                <div className="bg-white rounded-lg shadow-lg p-6 border-2 border-red-200">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">File Your Nationwide Claim</h3>
                  ...
                  <div className="mt-4 pt-4 border-t">
                    ...
                    <ul className="text-sm text-gray-700 mt-2 space-y-1">
                      <li>• Nationwide policy number</li>
