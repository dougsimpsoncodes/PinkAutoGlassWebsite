...
export const metadata: Metadata = {
  title: 'Farmers Windshield Replacement | $0 Deductible CO | (720) 918-7465',
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/services/insurance-claims/farmers',
  },
  openGraph: {
    title: 'Farmers Windshield Replacement Denver | $0 Deductible Often',
    description: 'Farmers approved • We file your claim • Direct billing • Often $0 deductible • Call (720) 918-7465',
    url: 'https://pinkautoglass.com/services/insurance-claims/farmers',
    type: 'website',
  },
};
...
export default function StateFarmInsurancePage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Farmers', url: 'https://pinkautoglass.com/services/insurance-claims/farmers' }
  ]);
        ...
        <section className="bg-gradient-to-r from-red-600 to-red-800 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <CTAButtons source="farmers-insurance" />
            </div>
          </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Farmers', href: '/services/insurance-claims/farmers' }
            ]}
          />
        </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-4 space-y-6">
                <div className="bg-white rounded-lg shadow-lg p-6 border-2 border-red-200">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">File Your Farmers Claim</h3>
