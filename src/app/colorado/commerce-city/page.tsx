...
export const metadata: Metadata = {
  ...
  title: 'Windshield Replacement Commerce City CO | Mobile',
  description: 'Mobile windshield replacement & repair in Commerce City CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/commerce-city/',
  },
  openGraph: {
    title: 'Windshield Replacement Commerce City CO | Mobile',
    description: 'Mobile windshield replacement & repair in Commerce City CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/commerce-city/',
    type: 'website',
  },
};
...
export default function CommerceCityLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Commerce City, CO', url: 'https://pinkautoglass.com/colorado/commerce-city/' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Commerce City, CO', href: '/colorado/commerce-city/' }
            ]}
          />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="mt-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">
                  Our Services in Commerce City
                </h2>
                <p className="text-gray-700 mb-4">
                  We bring a full range of auto glass services directly to you in Commerce City:
                </p>
