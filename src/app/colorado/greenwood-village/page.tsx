...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/greenwood-village/',
  },
  openGraph: {
    title: 'Windshield Replacement Greenwood Village | Mobile',
    description: 'Mobile windshield replacement & repair in Greenwood Village CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/greenwood-village/',
    type: 'website',
  },
};
...
export default function GreenwooodVillageLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Greenwood Village, CO', url: 'https://pinkautoglass.com/colorado/greenwood-village/' }
  ]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Locations', href: '/colorado' }, { label: 'Greenwood Village, CO', href: '/colorado/greenwood-village/' }]} />
        </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="mb-8">
                ...
                <div className="flex flex-wrap gap-4">
                  <Link href="/colorado/cherry-hills-village" className="text-pink-600 hover:underline font-medium">Cherry Hills Village</Link>
                  ...
                  <Link href="/colorado/lone-tree" className="text-pink-600 hover:underline font-medium">Lone Tree</Link>
                </div>
              </section>
              ...
              <div className="sticky top-4 space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li><Link href="/colorado/cherry-hills-village" className="text-pink-600 hover:underline">Cherry Hills Village, CO →</Link></li>
                    <li><Link href="/colorado/lone-tree" className="text-pink-600 hover:underline">Lone Tree, CO →</Link></li>
                  </ul>
                </div>
