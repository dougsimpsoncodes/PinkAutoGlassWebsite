...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/evergreen/',
  },
  openGraph: {
    title: 'Windshield Replacement Evergreen CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Evergreen CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/evergreen/',
    type: 'website',
  },
};
...
export default function EvergreenLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Evergreen, CO', url: 'https://pinkautoglass.com/colorado/evergreen/' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Evergreen, CO', href: '/colorado/evergreen/' }
            ]}
          />
        </div>
