...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/golden/',
  },
  openGraph: {
    title: 'Windshield Replacement Golden CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Golden CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/golden/',
    type: 'website',
  },
};
...
export default function GoldenLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Golden, CO', url: 'https://pinkautoglass.com/colorado/golden/' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Golden, CO', href: '/colorado/golden/' }
            ]}
          />
        </div>
