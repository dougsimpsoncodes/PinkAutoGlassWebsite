...
export const metadata: Metadata = {
  ...
  title: 'Windshield Replacement Loveland CO | Mobile, $0 Deductible',
  description: 'Mobile windshield replacement & repair in Loveland CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/loveland/',
  },
  openGraph: {
    title: 'Windshield Replacement Loveland CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Loveland CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/loveland/',
    type: 'website',
  },
};
...
export default function LovelandLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Loveland, CO', url: 'https://pinkautoglass.com/colorado/loveland/' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Loveland, CO', href: '/colorado/loveland/' }
            ]}
          />
        </div>
