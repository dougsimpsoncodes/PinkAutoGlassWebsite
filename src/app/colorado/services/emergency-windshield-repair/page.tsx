...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/services/emergency-windshield-repair',
  },
  openGraph: {
    title: "Emergency Windshield Repair | Same-Day 24/7 Mobile",
    description: "Urgent windshield repair and replacement. Available 24/7 with same-day mobile service across CO & AZ.",
    url: "https://pinkautoglass.com/colorado/services/emergency-windshield-repair",
