...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/services/adas-calibration',
  },
  openGraph: {
    title: 'ADAS Calibration | After Windshield Replacement',
...
export default function AdasCalibrationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'ADAS Calibration', url: 'https://pinkautoglass.com/colorado/services/adas-calibration' }
  ]);
