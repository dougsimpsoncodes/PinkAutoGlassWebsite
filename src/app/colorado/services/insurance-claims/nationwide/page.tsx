...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/services/insurance-claims/nationwide',
  },
  openGraph: {
    title: 'Nationwide Windshield Replacement CO | $0 Deductible',
    description: 'Nationwide approved • We file your claim • Direct billing • Often $0 deductible • Call (720) 918-7465',
    url: 'https://pinkautoglass.com/colorado/services/insurance-claims/nationwide',
    type: 'website',
  },
};
...
export default function StateFarmInsurancePage() {
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Simply call us at (720) 918-7465 or book online. We\'ll gather your Nationwide policy information and file the claim for you. You can also call Nationwide first at 1-800-1-800-NATIONWIDE, but it\'s not required - we handle everything for you.'
    },
    {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Nationwide', url: 'https://pinkautoglass.com/colorado/services/insurance-claims/nationwide' }
  ]);
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <div className="space-y-4">
                  {[
                    { num: 1, title: 'Call Us First', desc: 'Call (720) 918-7465 or book online. Have your Nationwide policy number ready (it\'s on your insurance card or app).' },
