...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/services/insurance-claims/travelers',
  },
  openGraph: {
    title: 'Travelers Windshield Replacement CO | $0 Deductible',
    description: 'Travelers approved • We file your claim • Direct billing • Often $0 deductible • Call (720) 918-7465',
    url: 'https://pinkautoglass.com/colorado/services/insurance-claims/travelers',
    type: 'website',
  },
};
...
export default function StateFarmInsurancePage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Travelers', url: 'https://pinkautoglass.com/colorado/services/insurance-claims/travelers' }
  ]);
