...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/windsor/',
  },
  openGraph: {
    title: 'Windshield Replacement Windsor CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Windsor CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/windsor/',
    type: 'website',
  },
};
...
export default function WindsorLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Windsor, CO', url: 'https://pinkautoglass.com/colorado/windsor/' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Windsor, CO', href: '/colorado/windsor/' }
            ]}
          />
        </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="mt-8">
                ...
                <p className="text-gray-700 mb-4">
                  We bring a full range of auto glass services directly to you in Windsor:
                </p>
