...
export const metadata: Metadata = {
  ...
  description: 'Mobile windshield replacement & repair in Fort Collins CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/fort-collins/',
  },
  openGraph: {
    title: 'Windshield Replacement Fort Collins CO | Mobile',
    description: 'Mobile windshield replacement & repair in Fort Collins CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/fort-collins/',
    type: 'website',
  },
};
