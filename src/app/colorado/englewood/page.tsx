...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/englewood/',
  },
  openGraph: {
    title: 'Windshield Replacement Englewood CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Englewood CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/englewood/',
    type: 'website',
  },
};
...
export default function EnglewoodLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Englewood, CO', url: 'https://pinkautoglass.com/colorado/englewood/' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Englewood, CO', href: '/colorado/englewood/' }
            ]}
          />
        </div>
