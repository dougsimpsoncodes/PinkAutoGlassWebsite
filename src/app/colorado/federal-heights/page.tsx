...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/federal-heights/',
  },
  openGraph: {
    title: 'Windshield Replacement Federal Heights CO | Mobile',
    description: 'Mobile windshield replacement & repair in Federal Heights CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/federal-heights/',
    type: 'website',
  },
};
...
export default function FederalHeightsLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Federal Heights, CO', url: 'https://pinkautoglass.com/colorado/federal-heights/' }
  ]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Locations', href: '/colorado' }, { label: 'Federal Heights, CO', href: '/colorado/federal-heights/' }]} />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="mt-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">
                  Our Services in Federal Heights
                </h2>
                <p className="text-gray-700 mb-4">
                  We bring a full range of auto glass services directly to you in Federal Heights:
                </p>
              ...
              <section className="mb-8">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Link href="/colorado/northglenn" className="text-pink-600 hover:underline font-medium">Northglenn</Link>
                  <Link href="/colorado/arvada" className="text-pink-600 hover:underline font-medium">Arvada</Link>
                </div>
              </section>
              ...
              <div className="sticky top-4 space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li><Link href="/colorado/northglenn" className="text-pink-600 hover:underline">Northglenn, CO →</Link></li>
