...
export const metadata: Metadata = {
  ...
  title: 'Windshield Replacement Longmont CO | Mobile, $0 Deductible',
  description: 'Mobile windshield replacement & repair in Longmont CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/longmont/',
  },
  openGraph: {
    title: 'Windshield Replacement Longmont CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Longmont CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/longmont/',
    type: 'website',
  },
};
...
export default function LongmontLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Longmont, CO', url: 'https://pinkautoglass.com/colorado/longmont/' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Longmont, CO', href: '/colorado/longmont/' }
            ]}
          />
        </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="mt-8">
                ...
                <p className="text-gray-700 mb-4">
                  We bring a full range of auto glass services directly to you in Longmont:
                </p>
