...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/colorado-springs/',
  },
  openGraph: {
    title: 'Windshield Replacement Colorado Springs | Mobile',
    description: 'Mobile windshield replacement & repair in Colorado Springs CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/colorado-springs/',
    type: 'website',
  },
};
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <NeighborhoodLinks citySlug="colorado-springs" basePath="/colorado/colorado-springs" />
