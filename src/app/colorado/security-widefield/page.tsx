...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/security-widefield/',
  },
  openGraph: {
    title: 'Windshield Replacement Security Widefield | Mobile',
    description: 'Mobile windshield replacement & repair in Security Widefield CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/security-widefield/',
    type: 'website',
  },
};
...
export default function SecurityWidefieldLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Security-Widefield, CO', url: 'https://pinkautoglass.com/colorado/security-widefield/' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Security-Widefield, CO', href: '/colorado/security-widefield/' }
            ]}
          />
        </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="mb-8">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Link href="/colorado/cimarron-hills" className="text-pink-600 hover:underline font-medium">Cimarron Hills</Link>
