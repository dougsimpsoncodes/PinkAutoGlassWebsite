...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/boulder/',
  },
  openGraph: {
    title: 'Windshield Replacement Boulder CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Boulder CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/boulder/',
    type: 'website',
  },
};
...
export default function BoulderLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Boulder, CO', url: 'https://pinkautoglass.com/colorado/boulder/' }
  ]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Locations', href: '/locations' }, { label: 'Boulder, CO', href: '/colorado/boulder/' }]} />
        </div>
