...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/westminster/',
  },
  openGraph: {
    title: 'Windshield Replacement Westminster CO | $0 Deductible',
    description: 'Mobile windshield replacement & repair in Westminster CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/westminster/',
    type: 'website',
  },
};
...
export default function WestminsterLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Westminster, CO', url: 'https://pinkautoglass.com/colorado/westminster/' }
  ]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Locations', href: '/colorado' }, { label: 'Westminster, CO', href: '/colorado/westminster/' }]} />
        </div>
              ...
              <div className="sticky top-4 space-y-6">
                ...
                <div className="bg-blue-50 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <Link href="/colorado/arvada" className="text-blue-600 hover:underline">Arvada</Link>
