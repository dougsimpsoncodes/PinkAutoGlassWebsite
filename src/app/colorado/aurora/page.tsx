...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/aurora',
  },
  openGraph: {
    title: 'Windshield Replacement Aurora CO — From $299, Mobile Service',
    description: 'Same-day mobile windshield replacement in Aurora CO from $299. We come to you anywhere in Aurora — book online or call (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/aurora',
    type: 'website',
  },
};
...
export default function AuroraLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Aurora, CO', url: 'https://pinkautoglass.com/colorado/aurora' }
  ]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Colorado', href: '/colorado' }, { label: 'Aurora, CO', href: '/colorado/aurora' }]} />
        </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <NeighborhoodLinks citySlug="aurora" basePath="/colorado/aurora" />
