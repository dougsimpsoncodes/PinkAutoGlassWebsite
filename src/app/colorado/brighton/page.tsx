...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/brighton/',
  },
  openGraph: {
    title: 'Windshield Replacement Brighton CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Brighton CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/brighton/',
    type: 'website',
  },
};
...
export default function BrightonLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Brighton, CO', url: 'https://pinkautoglass.com/colorado/brighton/' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Brighton, CO', href: '/colorado/brighton/' }
            ]}
          />
        </div>
