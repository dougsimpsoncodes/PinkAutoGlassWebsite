...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/castle-rock/',
  },
  openGraph: {
    title: 'Windshield Replacement Castle Rock CO | $0 Deductible',
    description: 'Mobile windshield replacement & repair in Castle Rock CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/castle-rock/',
    type: 'website',
  },
};

export default function CastleRockLocationPage() {
  const faqs = [
    {
      question: 'Do you offer mobile windshield service in Castle Rock?',
      answer: 'Yes! Mobile service is our specialty in Castle Rock. We come to your home, office, or anywhere in Castle Rock and surrounding areas. We\'ll come to you with our fully equipped mobile units.'
    },
    {
      question: 'How quickly can you replace a windshield in Castle Rock?',
      answer: 'We offer same-day windshield replacement throughout Castle Rock. Most appointments are completed within 2-4 hours of your call. The actual replacement takes 60-90 minutes, and we recommend at least 1 hour of cure time before driving.'
    },
    {
      question: 'What areas of Castle Rock do you serve?',
      answer: 'We serve all of Castle Rock including Downtown Castle Rock, The Meadows, Crystal Valley and all surrounding areas. If you\'re in the Castle Rock area, we\'ll come to you.'
    },
    {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Castle Rock, CO', url: 'https://pinkautoglass.com/colorado/castle-rock/' }
  ]);
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="flex items-center justify-center mb-4">
                ...
                <span className="text-xl">Castle Rock, Colorado</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Castle Rock, CO', href: '/colorado/castle-rock/' }
            ]}
          />
        </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">
                  Why Castle Rock Residents Choose Pink Auto Glass
                </h2>
                <p className="text-lg text-gray-700 mb-4">
                  Castle Rock's mix of residential neighborhoods and busy I-25 corridor means your windshield faces constant challenges. Pink Auto Glass is Castle Rock's trusted solution for fast, professional auto glass repair and replacement.
                </p>
              ...
              <section className="mt-8">
                ...
                <p className="text-gray-700 mb-4">
                  We bring a full range of auto glass services directly to you in Castle Rock:
                </p>
              ...
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Castle Rock Service Area</h2>
                <div className="grid md:grid-cols-2 gap-4">
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      <MapPin className="w-5 h-5 text-pink-600 mr-2 mt-1 flex-shrink-0" />
                      <span>Downtown Castle Rock</span>
                    </li>
                  <li className="flex items-start">
                      <MapPin className="w-5 h-5 text-pink-600 mr-2 mt-1 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                      <MapPin className="w-5 h-5 text-pink-600 mr-2 mt-1 flex-shrink-0" />
                      <span>Founders Village</span>
                    </li>
                  <li className="flex items-start">
                      <MapPin className="w-5 h-5 text-pink-600 mr-2 mt-1 flex-shrink-0" />
                      <span>Surrounding Douglas County</span>
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Frequently Asked Questions - Castle Rock</h2>
        ...
        <section className="bg-gradient-to-r from-pink-600 to-pink-700 text-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Ready to Fix Your Windshield in Castle Rock?
            </h2>
            <p className="text-xl mb-8 text-pink-100">
              Same-day mobile service throughout Castle Rock
            </p>
            <CTAButtons source="castle-rock-co-footer" />
          </div>
        </section>
      </div>
    </>
