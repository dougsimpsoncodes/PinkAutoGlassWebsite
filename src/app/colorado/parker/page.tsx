...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/parker/',
  },
  openGraph: {
    title: 'Windshield Replacement Parker CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Parker CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/parker/',
    type: 'website',
  },
};
...
export default function ParkerLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Parker, CO', url: 'https://pinkautoglass.com/colorado/parker/' }
  ]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Locations', href: '/colorado' }, { label: 'Parker, CO', href: '/colorado/parker/' }]} />
        </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="mb-8">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Link href="/colorado/franktown" className="text-pink-600 hover:underline font-medium">Franktown</Link>
                </div>
              </section>
              ...
              <div className="sticky top-4 space-y-6">
                ...
                <div className="bg-blue-50 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <Link href="/colorado/castle-rock" className="text-blue-600 hover:underline">Castle Rock</Link>
                  </div>
                </div>
