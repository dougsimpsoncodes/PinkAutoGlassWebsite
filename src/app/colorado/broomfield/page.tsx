...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/broomfield/',
  },
  openGraph: {
    title: 'Windshield Replacement Broomfield CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Broomfield CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/broomfield/',
    type: 'website',
  },
};
...
export default function BroomfieldLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Broomfield, CO', url: 'https://pinkautoglass.com/colorado/broomfield/' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Broomfield, CO', href: '/colorado/broomfield/' }
            ]}
          />
        </div>
