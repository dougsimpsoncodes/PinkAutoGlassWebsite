...
export const metadata: Metadata = {
  title: 'Windshield Replacement Louisville CO | Mobile, $0 Deductible',
  description: 'Mobile windshield replacement & repair in Louisville CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/louisville/',
  },
  openGraph: {
    title: 'Windshield Replacement Louisville CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Louisville CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/louisville/',
    type: 'website',
  },
};
...
export default function LouisvilleLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Louisville, CO', url: 'https://pinkautoglass.com/colorado/louisville/' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Louisville, CO', href: '/colorado/louisville/' }
            ]}
          />
        </div>
              ...
              <div className="sticky top-4 space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <ul className="space-y-2">
                    <li>
                      <Link href="/colorado/lafayette" className="text-pink-600 hover:underline">
                        Lafayette, CO &rarr;
                      </Link>
                    </li>
                    <li>
                      <Link href="/colorado/superior" className="text-pink-600 hover:underline">
                        Superior, CO &rarr;
                      </Link>
                    </li>
                    <li>
