...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/lakewood/',
  },
  openGraph: {
    title: 'Windshield Replacement Lakewood CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Lakewood CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/lakewood/',
    type: 'website',
  },
};
...
export default function LakewoodLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Lakewood, CO', url: 'https://pinkautoglass.com/colorado/lakewood/' }
  ]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Locations', href: '/colorado' }, { label: 'Lakewood, CO', href: '/colorado/lakewood/' }]} />
        </div>
              ...
              <div className="sticky top-4 space-y-6">
                ...
                <div className="bg-blue-50 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <Link href="/colorado/golden" className="text-blue-600 hover:underline">Golden</Link>
