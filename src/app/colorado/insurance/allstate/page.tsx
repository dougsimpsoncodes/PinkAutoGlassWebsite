...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/insurance/allstate',
  },
  openGraph: {
    title: 'Allstate Windshield Replacement CO | $0 Deductible',
    description: 'Allstate covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Allstate directly. Call (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/insurance/allstate',
    type: 'website',
  },
};
...
export default function AllstatePage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Allstate', url: 'https://pinkautoglass.com/colorado/insurance/allstate' },
  ]);
