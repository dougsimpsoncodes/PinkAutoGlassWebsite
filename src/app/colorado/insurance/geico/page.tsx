...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/insurance/geico',
  },
  openGraph: {
    title: 'Geico Windshield Replacement CO | $0 Deductible',
    description: 'Geico covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Geico directly. Call (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/insurance/geico',
    type: 'website',
  },
};
...
export default function GeicoPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Geico', url: 'https://pinkautoglass.com/colorado/insurance/geico' },
  ]);
