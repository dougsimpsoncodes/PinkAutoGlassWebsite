...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/insurance/safeco',
  },
  openGraph: {
    title: 'Safeco Windshield Replacement CO | $0 Deductible',
    description: 'Safeco covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Safeco directly. Call (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/insurance/safeco',
    type: 'website',
  },
};
...
export default function SafecoPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Safeco', url: 'https://pinkautoglass.com/colorado/insurance/safeco' },
  ]);
