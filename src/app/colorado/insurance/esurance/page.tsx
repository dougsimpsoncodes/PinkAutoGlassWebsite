...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/insurance/esurance',
  },
  openGraph: {
    title: 'Esurance Windshield Replacement CO | $0 Deductible',
    description: 'Esurance covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Esurance directly. Call (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/insurance/esurance',
    type: 'website',
  },
};
...
export default function EsurancePage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Esurance', url: 'https://pinkautoglass.com/colorado/insurance/esurance' },
  ]);
