...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/insurance/state-farm',
  },
  openGraph: {
    title: 'State Farm Windshield Replacement CO | $0 Deductible',
    description: 'State Farm covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill State Farm directly. (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/insurance/state-farm',
    type: 'website',
  },
};
...
export default function StateFarmPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'State Farm', url: 'https://pinkautoglass.com/colorado/insurance/state-farm' },
  ]);
