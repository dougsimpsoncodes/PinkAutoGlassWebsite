...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/insurance/aaa',
  },
  openGraph: {
    title: 'AAA Windshield Replacement CO | $0 Deductible',
    description: 'AAA covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill AAA directly. Call (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/insurance/aaa',
    type: 'website',
  },
};
...
export default function AAAPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'AAA', url: 'https://pinkautoglass.com/colorado/insurance/aaa' },
  ]);
