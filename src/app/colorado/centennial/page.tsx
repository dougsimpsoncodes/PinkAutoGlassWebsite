...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/colorado/centennial/',
  },
  openGraph: {
    title: 'Windshield Replacement Centennial CO | Mobile, $0 Deductible',
    description: 'Mobile windshield replacement & repair in Centennial CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
    url: 'https://pinkautoglass.com/colorado/centennial/',
    type: 'website',
  },
};
...
export default function CentennialLocationPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Centennial, CO', url: 'https://pinkautoglass.com/colorado/centennial/' }
  ]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Locations', href: '/colorado' }, { label: 'Centennial, CO', href: '/colorado/centennial/' }]} />
        </div>
