...
export const SATELLITE_DOMAINS = [
  ...
  { domain: 'windshieldchiprepairdenver.com', utmSource: 'windshieldchiprepairdenver', label: 'Chip Repair Denver', color: '#f59e0b' },
  { domain: 'windshieldchiprepairboulder.com', utmSource: 'windshieldchiprepairboulder', label: 'Chip Repair Boulder', color: '#10b981' },
  ...
  { domain: 'cheapestwindshieldnearme.com', utmSource: 'cheapestwindshieldnearme', label: 'Cheapest WS Near Me', color: '#ef4444' },
