...
export const metadata: Metadata = {
  title: "Arizona Windshield Replacement | $0 Out of Pocket | Pink Auto Glass",
  description:
  ...
  openGraph: {
    ...
    description:
      "AZ law means $0 deductible for windshield replacement. Pink Auto Glass serves all Phoenix metro. Same-day mobile service. (480) 712-7465.",
    url: "https://pinkautoglass.com/arizona/",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/arizona/services/insurance-claims/"
