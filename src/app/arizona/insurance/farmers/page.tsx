...
export const metadata: Metadata = {
  ...
  description: 'Farmers covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Farmers directly. Call (480) 712-7465.',
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/insurance/farmers',
  },
  openGraph: {
    title: 'Farmers Windshield Replacement CO | $0 Deductible',
    description: 'Farmers covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Farmers directly. Call (480) 712-7465.',
    url: 'https://pinkautoglass.com/arizona/insurance/farmers',
    type: 'website',
  },
};
...
export default function FarmersPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Farmers', url: 'https://pinkautoglass.com/arizona/insurance/farmers' },
  ]);
