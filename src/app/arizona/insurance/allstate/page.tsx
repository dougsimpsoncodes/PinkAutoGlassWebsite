...
export const metadata: Metadata = {
  ...
  description: 'Allstate covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Allstate directly. Call (480) 712-7465.',
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/insurance/allstate',
  },
  openGraph: {
    title: 'Allstate Windshield Replacement CO | $0 Deductible',
    description: 'Allstate covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Allstate directly. Call (480) 712-7465.',
    url: 'https://pinkautoglass.com/arizona/insurance/allstate',
    type: 'website',
  },
};
...
export default function AllstatePage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Allstate', url: 'https://pinkautoglass.com/arizona/insurance/allstate' },
  ]);
          ...
          <div className="lg:grid lg:grid-cols-[1fr_380px] lg:gap-10 lg:items-start">
            ...
            <aside className="hidden lg:block">
              <div className="sticky top-24">
                <InsuranceQuoteForm carrier="Allstate" source="insurance-allstate" />
              </div>
            </aside>
          </div>
        </div>
