...
export const metadata: Metadata = {
  ...
  description: 'Esurance covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Esurance directly. Call (480) 712-7465.',
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/insurance/esurance',
  },
  openGraph: {
    title: 'Esurance Windshield Replacement CO | $0 Deductible',
    description: 'Esurance covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Esurance directly. Call (480) 712-7465.',
    url: 'https://pinkautoglass.com/arizona/insurance/esurance',
    type: 'website',
  },
};
