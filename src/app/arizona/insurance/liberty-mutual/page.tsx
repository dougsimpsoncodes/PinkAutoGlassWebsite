...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/insurance/liberty-mutual',
  },
  openGraph: {
    title: 'Liberty Mutual Windshield Replacement CO | $0 Deductible',
    description: 'Liberty Mutual covers windshield replacement in Colorado — often $0. We handle all paperwork and bill Liberty Mutual directly. (480) 712-7465.',
    url: 'https://pinkautoglass.com/arizona/insurance/liberty-mutual',
    type: 'website',
  },
};
...
export default function LibertyMutualPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Liberty Mutual', url: 'https://pinkautoglass.com/arizona/insurance/liberty-mutual' },
  ]);
