...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/insurance/progressive',
  },
  openGraph: {
    title: 'Progressive Windshield Replacement CO | $0 Deductible',
    description: 'Progressive covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Progressive directly. (480) 712-7465.',
    url: 'https://pinkautoglass.com/arizona/insurance/progressive',
    type: 'website',
  },
};
...
export default function ProgressivePage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Progressive', url: 'https://pinkautoglass.com/arizona/insurance/progressive' },
  ]);
