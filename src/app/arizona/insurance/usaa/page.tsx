...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/insurance/usaa',
  },
  openGraph: {
    title: 'USAA Windshield Replacement CO | $0 Deductible',
    description: 'USAA covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill USAA directly. Call (480) 712-7465.',
    url: 'https://pinkautoglass.com/arizona/insurance/usaa',
    type: 'website',
  },
};
...
export default function USAAPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'USAA', url: 'https://pinkautoglass.com/arizona/insurance/usaa' },
  ]);
