...
export const metadata: Metadata = {
  ...
  description: 'State Farm covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill State Farm directly. (480) 712-7465.',
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/insurance/state-farm',
  },
  openGraph: {
    title: 'State Farm Windshield Replacement CO | $0 Deductible',
    description: 'State Farm covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill State Farm directly. (480) 712-7465.',
    url: 'https://pinkautoglass.com/arizona/insurance/state-farm',
    type: 'website',
  },
};
...
export default function StateFarmPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'State Farm', url: 'https://pinkautoglass.com/arizona/insurance/state-farm' },
  ]);
