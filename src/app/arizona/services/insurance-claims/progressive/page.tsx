...
export const metadata: Metadata = {
  ...
  description: 'Progressive covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Progressive directly. (480) 712-7465.',
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/services/insurance-claims/progressive',
  },
  openGraph: {
    title: 'Progressive Windshield Replacement CO | $0 Deductible',
    description: 'Progressive covers windshield replacement in Colorado — often $0 deductible. We handle all paperwork and bill Progressive directly. (480) 712-7465.',
    url: 'https://pinkautoglass.com/arizona/services/insurance-claims/progressive',
    type: 'website',
  },
};
...
export default function ProgressiveInsurancePage() {
  const faqs = [
    ...
    },
    {
      ...
      answer: 'It\'s easy! Simply call us at (480) 712-7465 or book online. We\'ll gather your Progressive policy information, help you file the claim with Progressive, and handle all communication with them. You don\'t need to call Progressive first - we do everything for you.'
    },
    {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Progressive', url: 'https://pinkautoglass.com/arizona/services/insurance-claims/progressive' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Progressive', href: '/colorado/services/insurance-claims/progressive' }
            ]}
          />
        </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <div className="space-y-4">
                  {[
                    { num: 1, title: 'Call Us First', desc: 'Call (480) 712-7465 or book online. Have your Progressive policy number ready (it\'s on your insurance card).' },
              ...
              <div className="sticky top-4 space-y-6">
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li>
                      <Link href="/colorado/services/insurance-claims" className="text-blue-600 hover:underline">
