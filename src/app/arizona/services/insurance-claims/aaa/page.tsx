...
export const metadata: Metadata = {
  ...
  description: 'AAA approved auto repair shop. We handle your AAA windshield claim. Direct billing. Often $0 deductible. Same-day mobile service. Won\'t raise rates. Call (480) 712-7465.',
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/services/insurance-claims/aaa',
  },
  openGraph: {
    title: 'AAA Windshield Replacement | $0 Deductible CO',
    description: 'AAA approved • We file your claim • Direct billing • Often $0 deductible • Call (480) 712-7465',
    url: 'https://pinkautoglass.com/arizona/services/insurance-claims/aaa',
    type: 'website',
  },
};
...
export default function AAAInsurancePage() {
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Simply call us at (480) 712-7465 or book online. Provide your AAA policy information, and we\'ll handle filing the claim with AAA for you. You can also call AAA first at 1-800-AAA-HELP, but it\'s not required - we can start the process for you.'
    },
    {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'AAA', url: 'https://pinkautoglass.com/arizona/services/insurance-claims/aaa' }
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'AAA', href: '/colorado/services/insurance-claims/aaa' }
            ]}
          />
        </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <div className="space-y-4">
                  {[
                    { num: 1, title: 'Contact Us First', desc: 'Call (480) 712-7465 or book online. Have your AAA membership number and policy info ready.' },
