...
export default function ArizonaInsuranceClaimsPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Arizona', url: 'https://pinkautoglass.com/arizona/services/insurance-claims/arizona' }
  ]);

  const webPageSchema = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "name": "Arizona Windshield Insurance Claims | | $0 Deductible",
    "speakable": {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="answer-first text-lg text-orange-100 leading-relaxed mb-6 max-w-3xl mx-auto">
                Arizona law requires insurers to offer zero-deductible glass coverage — most Phoenix drivers already have it. Your rates can't go up, and you choose your shop. We handle your entire claim. You pay $0.
              </p>
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="bg-orange-50 border-l-4 border-orange-500 p-6 rounded-r-lg">
                    <h3 className="text-xl font-bold text-gray-900 mb-3">: The Zero-Deductible Law</h3>
                    ...
                    <p className="text-gray-700">
                      <strong>Note:</strong> Many competitors incorrectly cite for the zero-deductible law. The correct statute is. is the rate protection law (see below).
                    </p>
                  </div>

                  <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
                    <h3 className="text-xl font-bold text-gray-900 mb-3">No Rate Increase Protection</h3>
                    <p className="text-gray-700 mb-3">
                  ...
                  <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-r-lg">
                    <h3 className="text-xl font-bold text-gray-900 mb-3">Right to Choose Your Shop</h3>
                    <p className="text-gray-700 mb-3">
                      Arizona law that most Arizona drivers have never heard of — and that most insurance companies hope you don't know about. Under Arizona law, every Arizona driver has the explicit legal right to choose any auto glass repair shop they want for insurance-covered work.
                    </p>
                    <p className="text-gray-700 mb-3">
                      Your insurer can recommend Safelite or any other shop. They cannot require you to use it. And critically, under Arizona law, they must tell you that you have the right to choose any shop.
                    </p>
                    <p className="text-gray-700">
              ...
              <section>
                ...
                <div className="bg-yellow-50 border-2 border-yellow-400 rounded-xl p-6">
                  <p className="text-lg text-gray-800 font-semibold mb-4">
                    No. Arizona law explicitly prohibits your insurer from requiring you to use any specific shop.
                  </p>
                  ...
                  <p className="text-gray-700 mb-4">
                    What they are legally required to also tell you — though many do not — is that under Arizona law, you have the legal right to choose any shop you want. If you express a preference for a different shop, your insurer must honor it. They cannot deny your claim, delay your service, or penalize you in any way for choosing a shop other than Safelite.
                  </p>
                  <p className="text-gray-700">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      ...
                      { num: '4', title: 'Call Your Insurer Directly', desc: 'Ask: "Do I have zero-deductible glass coverage under?" The specific statute reference helps clarify what you\'re asking about.' },
                    ].map(item => (
              ...
              <section>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { num: 2, title: 'We Verify Your Coverage', desc: 'We call your insurer and verify that you have zero-deductible glass coverage under. We confirm the exact cost before any work begins — usually $0.' },
                    ...
                    { num: 4, title: 'We Assist With Filing', desc: 'We assist with filing all required claim documentation directly with your insurance company on your behalf under Arizona law.' },
