...
export const metadata: Metadata = {
  title: 'Travelers Windshield Replacement CO | $0 Deductible',
  description: 'Travelers approved shop. Often $0 deductible for glass in Colorado. We file your claim. Direct billing. Same-day mobile service. Won\'t raise rates. Call (480) 712-7465.',
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/services/insurance-claims/travelers',
  },
  openGraph: {
    title: 'Travelers Windshield Replacement CO | $0 Deductible',
    description: 'Travelers approved • We file your claim • Direct billing • Often $0 deductible • Call (480) 712-7465',
    url: 'https://pinkautoglass.com/arizona/services/insurance-claims/travelers',
    type: 'website',
  },
};
...
export default function StateFarmInsurancePage() {
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Simply call us at (480) 712-7465 or book online. We\'ll gather your Travelers policy information and file the claim for you. You can also call Travelers first at 1-800-1-800-TRAVELERS, but it\'s not required - we handle everything for you.'
    },
    {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Travelers', url: 'https://pinkautoglass.com/arizona/services/insurance-claims/travelers' }
  ]);
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <div className="max-w-md mx-auto mt-6">
                <InsuranceQuoteForm carrier="Travelers" source="travelers-insurance" />
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Travelers', href: '/colorado/services/insurance-claims/travelers' }
            ]}
          />
        </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Most Travelers drivers in Colorado qualify for <strong>zero-deductible</strong> windshield replacement. Give us your policy number — we handle everything.
                </p>
              ...
              <section>
                ...
                <div className="space-y-4">
                  {[
                    { num: 1, title: 'Call Us First', desc: 'Call (480) 712-7465 or book online. Have your Travelers policy number ready (it\'s on your insurance card or app).' },
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-4 space-y-6">
                <InsuranceQuoteForm carrier="Travelers" source="travelers-sidebar" />
