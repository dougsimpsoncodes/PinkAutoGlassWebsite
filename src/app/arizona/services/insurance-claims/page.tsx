...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/services/insurance-claims',
  },
  openGraph: {
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <p className="text-gray-600 mt-4 text-center">
                  Don't see your insurer? <a href="tel:+14807127465" className="text-teal-600 hover:underline font-semibold">Call us</a> - we work with all carriers!
                </p>
              </section>
