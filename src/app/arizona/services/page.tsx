...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/services',
  },
  openGraph: {
    title: 'Auto Glass Services | Repair & Replacement CO & AZ',
    description: 'Expert windshield repair, replacement, and ADAS calibration throughout Colorado.',
    url: 'https://pinkautoglass.com/arizona/services',
    type: 'website',
  },
};
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": {
          ...
          "url": "https://pinkautoglass.com/arizona/services/windshield-repair",
      ...
      },
      {
        ...
        "item": {
          ...
          "url": "https://pinkautoglass.com/arizona/services/adas-calibration",
      ...
      },
      {
        ...
        "item": {
          ...
          "url": "https://pinkautoglass.com/arizona/services/mobile-service",
      ...
      },
      {
        ...
        "item": {
          ...
          "url": "https://pinkautoglass.com/arizona/services/insurance-claims",
                ...
                <div className="bg-white rounded-lg p-5 border-l-4 border-blue-500 shadow-sm">
                  <div className="flex items-start mb-2">
                    ...
                    <div>
                      ...
                      <a href="tel:+14807127465" className="text-blue-600 font-bold hover:underline">Call (480) 712-7465</a>
