...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pinkautoglass.com/arizona/services/windshield-repair',
  },
  openGraph: {
    title: 'Windshield Chip & Crack Repair | $0 With Insurance',
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section>
                ...
                <p className="text-gray-600 text-sm">
                  <strong>Same-day mobile service available</strong> across all Colorado Front Range communities. Call <a href="tel:+14807127465" className="text-pink-600 hover:underline font-semibold">(480) 712-7465</a> to schedule.
                </p>
              </section>
