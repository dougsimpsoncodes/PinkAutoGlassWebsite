...
export const metadata: Metadata = {
  ...
  description: 'Windshield replacement & auto glass repair in El Mirage AZ. Same-day mobile service. Grand Avenue (US-60) corridor & all El Mirage. ARS 20-264 means $0 out of pocket. Call (480) 712-7465!',
