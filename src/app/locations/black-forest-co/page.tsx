...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Black Forest Windshield Repair & Replacement CO | Pink Auto Glass',
    description: 'Black Forest\'s trusted auto glass experts. Mobile service, same-day appointments, lifetime warranty.',
  ...
  const faqs = [
    {
      ...
      answer: 'Yes! Mobile service is our specialty in Black Forest. We come to your home, office, or anywhere in Black Forest. Our fully equipped mobile units serve all Black Forest neighborhoods including Shoup Road area, Hodgen Road, Black Forest Estates, and more.'
    },
    {
      question: 'How quickly can you replace a windshield in Black Forest?',
      answer: 'We offer same-day windshield replacement throughout Black Forest. Most appointments are completed within 2-4 hours of your call. The actual replacement takes 60-90 minutes, and we recommend at least 1 hour of cure time before driving.'
    },
    {
      question: 'What Black Forest neighborhoods do you serve?',
      answer: 'We serve all of Black Forest including: Shoup Road area, Hodgen Road, Black Forest Estates, and all other Black Forest areas. If you\'re anywhere in Black Forest, we\'ll come to you.'
    },
    {
      question: 'Does insurance cover windshield replacement in Black Forest?',
      answer: 'Yes, most comprehensive insurance policies in Colorado cover windshield replacement with zero deductible. We work with all major insurance companies and handle all the paperwork for Black Forest residents.'
    },
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Locations', href: '/locations' }, { label: 'Black Forest, CO', href: '/locations/black-forest-co' }]} />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-12">
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Black Forest Residents Choose Pink Auto Glass</h2>
                <p className="text-lg text-gray-700 mb-4">
                  Black Forest drivers deserve reliable auto glass service. With 14,000 residents, Black Forest's unique location creates specific windshield challenges. From Shoup Road area to Hodgen Road, Pink Auto Glass provides fast, professional windshield repair and replacement throughout Black Forest.
                </p>
                <AboveFoldCTA location="location-black-forest-co" />
                <p className="text-lg text-gray-700 mb-4">
                  Our fully equipped mobile units serve all Black Forest neighborhoods. We understand the unique challenges Black Forest drivers face and provide expert windshield care tailored to your needs.
                </p>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6 rounded-r-lg">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      ...
                      <span><strong>Northeast CO Springs</strong></span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>Rural residential</strong></span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>Pine forest area</strong></span>
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Black Forest Neighborhoods We Serve</h2>
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Shoup Road area</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Hodgen Road</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Black Forest Estates</span>
                  </div>
                </div>
              </section>

              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Our Services in Black Forest</h2>
              ...
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Common Questions from Black Forest Customers</h2>
              ...
              <section className="bg-gradient-to-r from-pink-600 to-pink-700 text-white rounded-xl p-8 text-center">
                ...
                <p className="text-xl mb-6 text-pink-100">Same-day mobile service anywhere in Black Forest. Call now for a free quote.</p>
