...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Lafayette Windshield Repair & Replacement CO | Pink Auto Glass',
    description: 'Lafayette\'s trusted auto glass experts. Mobile service, same-day appointments, lifetime warranty.',
    url: 'https://pinkautoglass.com/locations/lafayette-co',
    type: 'website',
  },
};
...
export default function LafayetteLocationPage() {
  const faqs = [
    {
      ...
      answer: 'Yes! Mobile service is our specialty in Lafayette. We come to your home, office, or anywhere in Lafayette. Our fully equipped mobile units serve all Lafayette neighborhoods including Old Town Lafayette, Indian Peaks, Waneka Lake, and more.'
    },
    {
    ...
    {
      question: 'What Lafayette neighborhoods do you serve?',
      answer: 'We serve all of Lafayette including: Old Town Lafayette, Indian Peaks, Waneka Lake, and all other Lafayette areas. If you\'re anywhere in Lafayette, we\'ll come to you.'
    },
    {
      question: 'Does insurance cover windshield replacement in Lafayette?',
      answer: 'Yes, most comprehensive insurance policies in Colorado cover windshield replacement with zero deductible. We work with all major insurance companies and handle all the paperwork for Lafayette residents.'
    },
  ];
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Lafayette, CO', url: 'https://pinkautoglass.com/locations/lafayette-co' }
  ]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        <section className="bg-gradient-to-r from-pink-600 to-pink-700 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <CTAButtons source="lafayette-co-hero" />
            </div>
          </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Locations', href: '/locations' }, { label: 'Lafayette, CO', href: '/locations/lafayette-co' }]} />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-12">
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Lafayette Residents Choose Pink Auto Glass</h2>
                <p className="text-lg text-gray-700 mb-4">
                  Lafayette drivers deserve reliable auto glass service. With 30,633 residents, Lafayette's unique location creates specific windshield challenges. From Old Town Lafayette to Indian Peaks, Pink Auto Glass provides fast, professional windshield repair and replacement throughout Lafayette.
                </p>
                <AboveFoldCTA location="location-lafayette-co" />
                <p className="text-lg text-gray-700 mb-4">
                  Our fully equipped mobile units serve all Lafayette neighborhoods. We understand the unique challenges Lafayette drivers face and provide expert windshield care tailored to your needs.
                </p>

                <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6 rounded-r-lg">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Lafayette's Windshield Challenges</h3>
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>US-287 corridor</strong></span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>Growing suburb</strong></span>
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Lafayette Neighborhoods We Serve</h2>
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Old Town Lafayette</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Indian Peaks</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Waneka Lake</span>
                  </div>
                </div>
              </section>

              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Our Services in Lafayette</h2>
              ...
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Common Questions from Lafayette Customers</h2>
              ...
              <section className="bg-gradient-to-r from-pink-600 to-pink-700 text-white rounded-xl p-8 text-center">
                ...
                <p className="text-xl mb-6 text-pink-100">Same-day mobile service anywhere in Lafayette. Call now for a free quote.</p>
                <CTAButtons source="lafayette-co-cta" />
              </section>
            </div>
