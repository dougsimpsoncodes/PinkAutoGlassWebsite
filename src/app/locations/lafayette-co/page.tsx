...
export const metadata: Metadata = {
  title: 'Windshield Repair & Replacement Lafayette, CO | Pink Auto Glass',
  description: 'Professional windshield repair and replacement in Lafayette, Colorado. Mobile service to your home or office. Same-day appointments in Boulder County. Call (720) 918-7465 for a free quote.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs
            items={[
              ...
              { label: 'Lafayette, CO', href: '/locations/lafayette-co' }
            ]}
          />
        </div>
