...
export default function GreenwoodVillageLocationPage() {
  const faqs = [
    {
      question: 'Do you offer mobile windshield service in Greenwood Village?',
      answer: 'Yes! Mobile service is our specialty in Greenwood Village. We come to your home, office, or anywhere in Greenwood Village. Our fully equipped mobile units serve all Greenwood Village neighborhoods including Cherry Creek South, Orchard Road, Fiddlers Green, and more.'
    },
    {
    ...
    },
    {
      ...
      answer: 'We serve all of Greenwood Village including: Cherry Creek South, Orchard Road, Fiddlers Green, and all other Greenwood Village areas. If you\'re anywhere in Greenwood Village, we\'ll come to you.'
    },
    {
            ...
            <div className="lg:col-span-2 space-y-12">
              <section>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Greenwood Village drivers deserve reliable auto glass service. With 16,000 residents, Greenwood Village's unique location creates specific windshield challenges. From Cherry Creek South to Orchard Road, Pink Auto Glass provides fast, professional windshield repair and replacement throughout Greenwood Village.
                </p>
                <AboveFoldCTA location="location-greenwood-village-co" />
                <p className="text-lg text-gray-700 mb-4">
                  Our fully equipped mobile units serve all Greenwood Village neighborhoods. We understand the unique challenges Greenwood Village drivers face and provide expert windshield care tailored to your needs.
                </p>

                <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6 rounded-r-lg">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Greenwood Village's Windshield Challenges</h3>
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>Upscale suburb</strong></span>
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Cherry Creek South</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Orchard Road</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Fiddlers Green</span>
                  </div>
                </div>
              </section>
