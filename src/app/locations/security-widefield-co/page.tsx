...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Security-Widefield Windshield Repair & Replacement CO | Pink Auto Glass',
    description: 'Security-Widefield\'s trusted auto glass experts. Mobile service, same-day appointments, lifetime warranty.',
  ...
  const faqs = [
    {
      ...
      answer: 'Yes! Mobile service is our specialty in Security-Widefield. We come to your home, office, or anywhere in Security-Widefield. Our fully equipped mobile units serve all Security-Widefield neighborhoods including Security, Widefield, Stratmoor, and more.'
    },
    {
    ...
    {
      question: 'What Security-Widefield neighborhoods do you serve?',
      answer: 'We serve all of Security-Widefield including: Security, Widefield, Stratmoor, and all other Security-Widefield areas. If you\'re anywhere in Security-Widefield, we\'ll come to you.'
    },
    {
      question: 'Does insurance cover windshield replacement in Security-Widefield?',
      answer: 'Yes, most comprehensive insurance policies in Colorado cover windshield replacement with zero deductible. We work with all major insurance companies and handle all the paperwork for Security-Widefield residents.'
    },
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Locations', href: '/locations' }, { label: 'Security-Widefield, CO', href: '/locations/security-widefield-co' }]} />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-12">
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Security-Widefield Residents Choose Pink Auto Glass</h2>
                <p className="text-lg text-gray-700 mb-4">
                  Security-Widefield drivers deserve reliable auto glass service. With 39,000 residents, Security-Widefield's unique location creates specific windshield challenges. From Security to Widefield, Pink Auto Glass provides fast, professional windshield repair and replacement throughout Security-Widefield.
                </p>
                <AboveFoldCTA location="location-security-widefield-co" />
                <p className="text-lg text-gray-700 mb-4">
                  Our fully equipped mobile units serve all Security-Widefield neighborhoods. We understand the unique challenges Security-Widefield drivers face and provide expert windshield care tailored to your needs.
                </p>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6 rounded-r-lg">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      ...
                      <span><strong>Fort Carson area</strong></span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>South CO Springs</strong></span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>Military community</strong></span>
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Security-Widefield Neighborhoods We Serve</h2>
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Widefield</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Stratmoor</span>
                  </div>
                </div>
              </section>

              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Our Services in Security-Widefield</h2>
              ...
              <section>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Common Questions from Security-Widefield Customers</h2>
              ...
              <section className="bg-gradient-to-r from-pink-600 to-pink-700 text-white rounded-xl p-8 text-center">
                ...
                <p className="text-xl mb-6 text-pink-100">Same-day mobile service anywhere in Security-Widefield. Call now for a free quote.</p>
