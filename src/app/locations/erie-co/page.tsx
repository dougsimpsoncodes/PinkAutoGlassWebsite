...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Erie Windshield Repair & Replacement CO | Pink Auto Glass',
    description: 'Erie\'s trusted auto glass experts. Mobile service, same-day appointments, lifetime warranty.',
  ...
  const faqs = [
    {
      ...
      answer: 'Yes! Mobile service is our specialty in Erie. We come to your home, office, or anywhere in Erie. Our fully equipped mobile units serve all Erie neighborhoods including Vista Ridge, Erie Highlands, Coal Ridge, and more.'
    },
    {
    ...
    },
    {
      ...
      answer: 'We serve all of Erie including: Vista Ridge, Erie Highlands, Coal Ridge, Colliers Hill, and all other Erie areas. If you\'re anywhere in Erie, we\'ll come to you.'
    },
    {
            ...
            <div className="lg:col-span-2 space-y-12">
              <section>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Erie drivers deserve reliable auto glass service. With 40,639 residents, Erie's unique location creates specific windshield challenges. From Vista Ridge to Erie Highlands, Pink Auto Glass provides fast, professional windshield repair and replacement throughout Erie.
                </p>
                <AboveFoldCTA location="location-erie-co" />
                <p className="text-lg text-gray-700 mb-4">
                  Our fully equipped mobile units serve all Erie neighborhoods. We understand the unique challenges Erie drivers face and provide expert windshield care tailored to your needs.
                </p>

                <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6 rounded-r-lg">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Erie's Windshield Challenges</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>Fastest growing town in CO</strong></span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>I-25 commuter traffic</strong></span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>New housing developments</strong></span>
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Vista Ridge</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Erie Highlands</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Coal Ridge</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Colliers Hill</span>
                  </div>
                </div>
              </section>
