...
export const metadata: Metadata = {
  title: 'Windshield Replacement Brighton CO | Mobile, $0 Deductible',
  description: 'Mobile windshield replacement & repair in Brighton CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="mt-8">
                ...
                <p className="text-gray-700 mb-4">
                  We bring a full range of auto glass services directly to you in Brighton:
                </p>
