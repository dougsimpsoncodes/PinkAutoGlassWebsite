  ...
  const faqs = [
    {
      ...
      answer: 'Yes! Mobile service is our specialty in Johnstown. We come to your home, office, or anywhere in Johnstown. Our fully equipped mobile units serve all Johnstown neighborhoods including Parish, Thompson Crossing, Johnstown Center, and more.'
    },
    {
    ...
    },
    {
      ...
      answer: 'We serve all of Johnstown including: Parish, Thompson Crossing, Johnstown Center, and all other Johnstown areas. If you\'re anywhere in Johnstown, we\'ll come to you.'
    },
    {
            ...
            <div className="lg:col-span-2 space-y-12">
              <section>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Johnstown drivers deserve reliable auto glass service. With 19,000 residents, Johnstown's unique location creates specific windshield challenges. From Parish to Thompson Crossing, Pink Auto Glass provides fast, professional windshield repair and replacement throughout Johnstown.
                </p>
                <AboveFoldCTA location="location-johnstown-co" />
                <p className="text-lg text-gray-700 mb-4">
                  Our fully equipped mobile units serve all Johnstown neighborhoods. We understand the unique challenges Johnstown drivers face and provide expert windshield care tailored to your needs.
                </p>

                <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6 rounded-r-lg">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Johnstown's Windshield Challenges</h3>
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>Near Fort Collins</strong></span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>Northern Front Range</strong></span>
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Parish</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Thompson Crossing</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Johnstown Center</span>
                  </div>
                </div>
              </section>
