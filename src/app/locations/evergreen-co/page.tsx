...
export const metadata: Metadata = {
  title: 'Windshield Replacement Evergreen CO | Mobile, $0 Deductible',
  description: 'Mobile windshield replacement & repair in Evergreen CO. Same-day service, $0 deductible often, lifetime warranty. We come to you! (720) 918-7465.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-12">
              ...
              <section className="mt-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">
                  Our Services in Evergreen
                </h2>
                <p className="text-gray-700 mb-4">
                  We bring a full range of auto glass services directly to you in Evergreen:
                </p>
