...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Sheridan Windshield Repair & Replacement CO | Pink Auto Glass',
    description: 'Sheridan\'s trusted auto glass experts. Mobile service, same-day appointments, lifetime warranty.',
    url: 'https://pinkautoglass.com/locations/sheridan-co',
    type: 'website',
  },
};
...
export default function SheridanLocationPage() {
  const faqs = [
    {
      ...
      answer: 'Yes! Mobile service is our specialty in Sheridan. We come to your home, office, or anywhere in Sheridan. Our fully equipped mobile units serve all Sheridan neighborhoods including Federal Boulevard area, Englewood border, and more.'
    },
    {
    ...
    },
    {
      ...
      answer: 'We serve all of Sheridan including: Federal Boulevard area, Englewood border, and all other Sheridan areas. If you\'re anywhere in Sheridan, we\'ll come to you.'
    },
    {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Sheridan, CO', url: 'https://pinkautoglass.com/locations/sheridan-co' }
  ]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 page-top-padding">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Breadcrumbs items={[{ label: 'Locations', href: '/locations' }, { label: 'Sheridan, CO', href: '/locations/sheridan-co' }]} />
        </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              <section>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Sheridan drivers deserve reliable auto glass service. With 6,000 residents, Sheridan's unique location creates specific windshield challenges. From Federal Boulevard area to Englewood border, Pink Auto Glass provides fast, professional windshield repair and replacement throughout Sheridan.
                </p>
                <AboveFoldCTA location="location-sheridan-co" />
                <p className="text-lg text-gray-700 mb-4">
                  Our fully equipped mobile units serve all Sheridan neighborhoods. We understand the unique challenges Sheridan drivers face and provide expert windshield care tailored to your needs.
                </p>

                <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6 rounded-r-lg">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Sheridan's Windshield Challenges</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>Central Denver metro</strong></span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>US-285 access</strong></span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-600 font-bold mr-2">•</span>
                      <span><strong>Dense population</strong></span>
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Federal Boulevard area</span>
                  </div>
                  <div className="bg-white border border-gray-200 rounded p-3 text-center hover:bg-pink-50 hover:border-pink-300 transition-colors">
                    <span className="text-gray-700 font-medium">Englewood border</span>
                  </div>
                </div>
              </section>
